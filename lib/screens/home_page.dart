...
import 'package:weather_api/data/img_path.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer2<WeatherProvider, LocatorProvider>(
          ...
          String backgroundImage = "assets/img/mist.png"; // Default background

          // Check if weather data is available
          if (weathervalue.weather != null) {
            String weatherCondition = weathervalue.weather!.clouds ?? "";
            backgroundImage =
                background[weatherCondition] ?? "assets/img/clouds.jpg";
          }
